...
public class PostActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        typeAdapter = new ArrayAdapter<String>(PostActivity.this,
        ...
        stateAdapter = new ArrayAdapter<String>(PostActivity.this,
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if ("text".equalsIgnoreCase(type)) {
                        DDClientInvoker.getInstance().postText(blogCName, state, tag, slug,
                                getPostTitle(), getBody(), postListener);

                    } else if ("photo".equalsIgnoreCase(type)) {
                        PrintLog.d(LOG_TAG, "caption:" + getCaption() + "\t" + getFilePath());
                        DDClientInvoker.getInstance().postPhoto(blogCName, state, tag, slug,
                                getCaption(), getFilePath(), postListener);
                    } else if ("link".equalsIgnoreCase(type)) {

                        DDClientInvoker.getInstance().postLink(blogCName, state, tag, slug,
                                getPostTitle(), getUrl(), getDesc(), postListener);
                    } else if ("audio".equalsIgnoreCase(type)) {
                        PrintLog.d(LOG_TAG, "caption:" + getCaption() + "\t" + getFilePath());
                        DDClientInvoker.getInstance().postAudio(blogCName, state, tag, slug,
                                getCaption(), getFilePath(), getMusicName(), getMusicSinger(),
                                postListener);

                    } else if ("video".equalsIgnoreCase(type)) {
                        PrintLog.d(LOG_TAG, "caption:" + getCaption() + "\t" + getFilePath());
                        DDClientInvoker.getInstance().postVideo(blogCName, state, tag, slug,
                                getCaption(), getUrl(), postListener);
                    } else {
