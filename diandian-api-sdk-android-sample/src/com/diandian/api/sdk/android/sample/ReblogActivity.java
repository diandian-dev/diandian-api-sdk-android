 ...
 *         2012-4-24 下午2:17:11
 */
public class ReblogActivity extends Activity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.reblog);
        final Handler handler = new Handler();
        final Button button = (Button) findViewById(R.id.button1);
        final EditText idText = (EditText) findViewById(R.id.editText1);
        final EditText tagText = (EditText) findViewById(R.id.editText2);
        final EditText blogCNameText = (EditText) findViewById(R.id.editText3);
        final EditText commentText = (EditText) findViewById(R.id.editText5);
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    DDClientInvoker.getInstance().reblogPost(blogCName, id, tag, comment,
                            new BaseDDListener() {
